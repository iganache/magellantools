...
def arcdr2csv(file, outpath, suffix = "adf"):
    ...
    if suffix == "rdf":
        df = pd.DataFrame(columns = ["orbit", "footprint", "flag", "xsize", "ysize", "lat", "lon", "bsc", "bsc_size", "thetai", "pradius", "Tb", "Te", "emis"])
    elif suffix == "adf":
        df = pd.DataFrame(columns = ["orbit", "footprint", "flag", "xsize", "ysize", "lat", "lon", "pradius", "rms_slope", "ref", "ref_corr", "multi_peak_fact"])
